...
class PointCloudVisualizer(QtWidgets.QMainWindow):
    ...
    def _update_line_graphs(self, visible_points):
        ...
        self.x_plot.plot(x_centers, x_counts, stepMode="center", 
        ...
        self.y_plot.plot(y_centers, y_counts, stepMode="center", 
        ...
        self.z_plot.plot(z_centers, z_counts, stepMode="center", 
