...
if uploaded_file is not None:
    ...
    if not required.issubset(df.columns):
        ...
        status_color = "green" if safe else "#f56767"  # Orange for better dark mode visibility
        ...
        <span style='color:#50fa7b;'>AIRL@Hiremath</span>:<span style='color:#8be9fd;'>~</span>$ Landing Zone Assessment Metrics<br><br>
        ...
        # Reason if unsafe, bright orange for dark background
        if not safe and metrics.get('reason', ''):
            html_content += f"Reason               : <b style='color:#f56767;'>{metrics['reason']}</b><br>"

        html_content += "</div>"

        # Display terminal-style box
