...
class RadarDespiker:
    def __init__(self, radius=0.5, base_z_thresh=0.3, base_xy_thresh=0.3, snr_gate=7.0):
        ...
        self.processing_time = 0.0  # Last processing time
    ...
    def process(self, det_obj, snr=None, noise=None):
        ...
        if curr_len == 0:
            # Initialize empty despike_info for zero points
            ...
            return {
                ...
                'despike_info': {
                    ...
                    'estimated_fps': self.estimate_fps()
                }
            }
        ...
        # Calculate despike frequency info
        valid_ratio = np.sum(valid_mask) / curr_len
        removed_ratio = 1.0 - valid_ratio
        ...
        # Return results with enhanced despike info
        return {
            'x': x_smooth, 
            'y': y_smooth, 
            'z': z_smooth, 
            ...
            'despike_info': {
                ...
                'processing_time_s': self.processing_time,
                'estimated_fps': self.estimate_fps(),
                'points_processed': curr_len
            }
        }
    
    def estimate_fps(self):
        """Calculate estimated frames per second based on recent processing times"""
        ...
        return min(1000.0, 1.0 / avg_time)  # Cap at 1000 FPS for stability